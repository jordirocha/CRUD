...
$(".edit").click(function () {
    ...
    id = $row.find(".idEmp").text();
    var userdata = {
        'id': id
    };
    $.ajax({
        type: "POST",
        url: "/simplecrud/src/app/select.php",
        data: userdata,
        success: function (data) {
            ...
            document.getElementById('content-modal-title').innerHTML = 'Updated Employee';
        }
    });
});
...
function updateEmployee() {
    ...
    $.ajax({
        type: "POST",
        url: "/simplecrud/src/app/update.php",
        data: userdata,
        success: function (data) {
...
$(".new").click(function () {
    ...
    $.ajax({
        type: "POST",
        url: "/simplecrud/src/app/jobs.php",
        success: function (data) {
    ...
    $.ajax({
        type: "POST",
        url: "/simplecrud/src/app/departments.php",
        success: function (data) {
...
function newEmployee() {
    ...
    $.ajax({
        type: "POST",
        url: "/simplecrud/src/app/insert.php",
        data: userdata,
        success: function (data) {
            window.location.reload(true);
...
function deleteEmployee() {
    ...
    $.ajax({
        type: "POST",
        url: "/simplecrud/src/app/delete.php",
        data: userdata,
        success: function (data) {
            window.location.reload(true);
